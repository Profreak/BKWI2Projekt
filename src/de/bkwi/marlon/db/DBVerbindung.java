...
public class DBVerbindung {
	...
	public boolean oeffneDB() {
		...
		try {
			...
			// Verbindung zur DB wird mit getConnection() über einen String
			// hergestellt
	...
	public ResultSet leseDB(String pSQL) {
		...
		ResultSet rs;
		try {
			// Ausführung der SQL-Anweisung mittels executeQuery(pSQL) im
			// Statement-Objekt und Zuweisung an die Ergebnistabelle
